...
<div class="row">
     <div class="col-lg-12">
        <div class="intro-text">
            ...
            <span class="boxtext"><i class="fa fa-sign-in"></i> Halaman Login <b>Calon Peserta Magang</b></span>
            ...
            <h4 class="text-success"><br><br>
               <img src="img\logo_bsp.png" width="50">
               Login Administrasi Calon Peserta Magang
            </h4>
            <div class="col-md-12">
             ...
             <span class="text-success"></span>
                <form action="" method="post">
                    ...
                    <div class="form-group has-feedback" style="margin-top:-20px;padding-left:15px;padding-right:15px">
                        <input type="password" name="password" class="inp" placeholder="NIM" required="true" />
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
