...
<head>
    ...
    <link rel="shortcut icon" href="img\logo_bsp.png" type="image/png">
            ...
            <div class="col-sm-12">
              ...
              <h2>
								<strong class="text-primary">
									<a href=""><img src="img/logo_bsp.png" alt="Logo" width="30" style="position:absolute;margin-top:-8px;"> <span style="margin-left:35px;color:#fff;">Penerimaan Magang Online</span></a>
								</strong>
							</h>
              </div>
            </div>
          ...
          <div class="header-right">
            <ul class="header-menu nav navbar-nav">
              ...
              <li class="dropdown" id="language-header">
                ...
                <span style="color:#ddd;">Pendaftaran magang <b class="text-danger" style="color:#fff;"></span>
                </a>
              </li>
            </ul>
          </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran Magang Online <strong> PT. Bumi Siak Pusako</strong></h2>
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <span style="font-size:15px">
                                 Proses Pendaftaran Magang Online PT. Bumi Siak Pusako hampir selesai. Silakan periksa kembali data-data yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
                                       <span class="text-primary" style="font-size:18px;"><strong>Apakah data calon peserta sudah sesuai dan lengkap?</strong></span>
                                       <div class="form-group">
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-right sm-pull-reset">
                <span><a href="" class="m-r-10"><i class="fa fa-home"></i> Beranda </a> | <a href="#" class="m-l-10 m-r-10" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-legal"></i>Ketentuan & Syarat</a></span>
              </p>
            </div>
          </div>
        </div>
